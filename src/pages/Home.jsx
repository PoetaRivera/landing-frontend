...
function Home() {
  return (
    <>
      <SEO
        title="Inicio"
        description="Sistema completo de gestión para salones de belleza. Reservas, clientes, inventario y más en una sola plataforma. Comienza gratis hoy."
        keywords="salón de belleza, gestión de salones, sistema de reservas, software para peluquerías, gestión de clientes, inventario para salones"
        url="https://misalons.com"
      />
      ...
      <div className="min-h-screen">
        ...
        {/* Features Section */}
        <FeaturesSection title="¿Por qué elegir MiSalons?" />
